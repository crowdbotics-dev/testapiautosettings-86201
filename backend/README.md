...
## Project Structure
    ...
    ├── testapiautosettings_86201  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_86201`
...
2. Clone this repo and `cd testapiautosettings_86201`
